...
public class Speach : MonoBehaviour
{
    ...
    static string[] Answers2Rus = new string[] { "- я ощущаю только небольшие сподвиги, а иногда чувствую себя как раньше" ,
        "- как будто и ничего и не было, я полностью здоров," ,
        "- а может хватит этих пустых слов? Я уже устал от всего этого, пора уже понять, что со мной все нормально" };
    ...
    static string[] Answers3Rus = new string[] { "- вернусь домой и наконец смогу остаться наедине с собой," ,
        "- вернусь на работу, заведу семью, детей, буду совершенно обыкновенно жить," ,
        "- после такого у меня есть будущее?" };
